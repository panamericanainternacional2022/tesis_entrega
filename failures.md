...
| **Sobrecalentamiento** | `overheat` | Ascenso térmico directo. La temperatura supera un 20% el umbral crítico. La corriente es ligeramente alta (+5% sobre crítico) y la vibración sube un 15% por dilatación térmica. Presión y caudal se mantienen operacionales con una leve degradación del 5%. | Temperatura, Vibración, Corriente, Caudal, Presión |
